...
public class NewJava/*@bgen(jjtree)*/implements NewJavaTreeConstants, NewJavaConstants {/*@bgen(jjtree)*/
  ...
  static final public void AssignAux() throws ParseException {
                        /*@bgen(jjtree) VAR */
                        SimpleNode jjtn000 = new SimpleNode(JJTVAR);
                        boolean jjtc000 = true;
                        jjtree.openNodeScope(jjtn000);Token t;
  ...
  static final public void FullStop() throws ParseException {
  ...
  static final public void VarTerm() throws ParseException {
                      Token t;Token open = new Token();Token close = new Token();
    if (jj_2_50(2)) {
      ...
      try {
        ...
        SimpleNode jjtn004 = new SimpleNode(JJTTRUE);
      ...
      try {
        ...
        SimpleNode jjtn006 = new SimpleNode(JJTTHIS);
      ...
      jj_consume_token(NOT);
              SimpleNode jjtn009 = new SimpleNode(JJTNOT);
  ...
  static final private JJCalls[] jj_2_rtns = new JJCalls[58];
